...
The accuracy of this model is `r confusionMatrix(validation$classe, predict(model3, validation))$overall[1]` , which is really nice. It has high sensitivity and also specificity for each classes. 
